<template>
  <div class="basic-settings">
    ...
    <!-- 系統設置標籤頁 -->
    <div v-show="currentTab === 'system'" class="content-section">
      ...
      <div class="permission-container">
        ...
        <div class="permission-content" v-if="selectedUser">
          ...
          <div class="permission-groups">
            <div 
              v-for="group in getCurrentTabPermissions" 
              :key="group.id"
...
const tabs = [
  { id: 'system', name: '系統設置' },
  { id: 'attendance', name: '考勤功能' },
  { id: 'task', name: '任務功能' },
  { id: 'post', name: '貼文功能' },
  { id: 'finance', name: '財務功能' },
  ...
  business: [
    {
      id: 'leads',
      name: '潛在客戶管理',
      description: '管理陌生客戶和電訪相關功能',
      permissions: [
        { id: 'manage_leads', name: '陌生客戶列表', description: '查看和管理陌生客戶資料，包含電訪記錄查看' },
        { id: 'manage_call_records', name: '電訪管理', description: '管理電訪結果，設置提醒' }
      ]
    },
    {
      id: 'prospects',
      ...
      permissions: [
        { id: 'manage_prospects', name: '意向客戶管理', description: '查看和管理意向客戶資料' },
        { id: 'manage_prospect_follow_ups', name: '跟進記錄', description: '記錄和管理客戶跟進，設置提醒' }
      ]
    },
    {
      id: 'customers',
      name: '合作客戶管理',
      description: '管理正式合作客戶相關功能',
      permissions: [
        { id: 'manage_customers', name: '客戶管理', description: '查看和管理合作客戶資料' },
        { id: 'manage_customer_contracts', name: '合約管理', description: '管理客戶合約，處理續約事項' }
      ]
    }
  ],
  admin: [
...
// 獲取當前標籤頁的權限組
const getCurrentTabPermissions = computed(() => {
  return permissionGroups[currentTab.value as keyof typeof permissionGroups] || []
})
